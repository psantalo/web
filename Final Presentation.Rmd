...
|reading|Readind mean score(2012)      |
|ps|Prolem Solving mean score(2012)   |
...
```
![2result](https://github.com/psantalo/web/tree/gh-pages/Results "2result.png")
...
p2 <- ggplot(lpisa, aes(Internet.users.growth, Score.growth))+
  geom_point(aes(colour = GDPperc_label),size=2)+
  labs(x = "Internet Users Growth", y = "PS Score Growth")+
  ggtitle("Internet Users Growth and PS Score Growth")+
  theme_bw()
plot(p2)
```

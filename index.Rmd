...
Then, we add the following explanetory variables to see the affect of interned accessibility on student's ability.
 - internet users (per 100 people)
 - mobile celler subscription (per 100 people)

...
###Math
ma.lm <- lm(math ~ log(GDPperc) + log(pop) +  popd, data=cdata)
ma.lm2 <- lm(math ~ log(GDPperc) + log(pop) +  popd + rteacher + eyear + expend, data =cdata)
ma.lm3 <- lm(math ~ log(GDPperc) + log(pop) +  popd + rteacher + eyear + expend + internet + mobile, data = cdata)
